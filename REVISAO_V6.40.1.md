# Borion Finance 6.40.1 — Revisão crítica de Dados e Segurança
...
2. Abra a versão 6.40.1 em uma janela anônima para garantir cache limpo.
...
2. Desative a publicação da 6.40.1 e restaure o ZIP/site anterior.
...
6. Se houver operações posteriores ao snapshot escolhido, não as apague: mantenha a 6.40.1 em ambiente isolado para consolidá-las e exportar uma base completa.
