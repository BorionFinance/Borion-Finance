  ...
  placeholder(){ return `<div class="help-loading-card"><span class="help-loading-spinner"></span><strong>Carregando a Central do Borion...</strong><span>Guias, checklist e história do sistema.</span></div>`; },
    ...
    this.promise = new Promise((resolve,reject)=>{
      if(!document.querySelector('link[data-borion-help-css]')){
        ...
        link.rel='stylesheet'; link.href='css/help-center.css?v=6.46.17'; link.dataset.borionHelpCss='1';
      ...
      script.src='js/26-help-center.js?v=6.46.17'; script.async=true; script.dataset.borionHelpScript='1';
...
/* V6.46.17 — recorte de foto de perfil. Sem dependências externas, só canvas puro.
...
const BORION_AVATAR_MAX_BYTES = 3*1024*1024; // V6.46.17 — antes 900 KB; a foto final sai redimensionada (512×512) pelo recorte, então não pesa o backup

/* V6.46.17 — nome, foto, cor e senha pertencem ao metadado do perfil, não aos
  ...
  reader.onload=()=>{
    openAvatarCropper(reader.result, async (croppedDataUrl)=>{
      ...
      try{
        ...
        // V6.46.17 — atualização otimista da interface: nome/cor/foto entram no estado
...
(function(){
  const SETTINGS_VERSION = '6.46.17';
...
/* ================= V6.46.17 — Avatares animados, galeria pronta e proteção das integrações ================= */
(function(){
