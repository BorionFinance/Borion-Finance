  ...
  placeholder(){ return `<div class="help-loading-card"><span class="help-loading-spinner"></span><strong>Carregando a Central do Borion...</strong><span>Guias, checklist e história do sistema.</span></div>`; },
    ...
    this.promise = new Promise((resolve,reject)=>{
      if(!document.querySelector('link[data-borion-help-css]')){
        ...
        link.rel='stylesheet'; link.href='css/help-center.css?v=6.45.4'; link.dataset.borionHelpCss='1';
      ...
      script.src='js/26-help-center.js?v=6.45.4'; script.async=true; script.dataset.borionHelpScript='1';
...
function renderSettings(){
  ...
  return `<div class="settings-layout">${tabs}<div class="settings-content">${content}</div><div class="version-tag">V. 6.45.4 — Sincronização MIT Corrigida</div><footer class="app-release-footer" aria-label="Informações do Borion">
<div><strong>Versão:</strong> 6.45.4</div>
