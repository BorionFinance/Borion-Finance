...
function renderSettings(){
  ...
  return `<div class="settings-layout">${tabs}<div class="settings-content">${content}</div><div class="version-tag">V. 6.34.3 • Scroll e estabilidade mobile</div><footer class="app-release-footer" aria-label="Informações do Borion">
<div><strong>Versão:</strong> 6.34.3</div>
