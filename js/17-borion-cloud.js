...
const CloudStorage = {
  ...
  async deleteAccountWithCredentials(email, password){
    ...
    if(rpcError){
      throw new Error('Não foi possível excluir a conta no Supabase. Rode o SQL docs-tecnicos/SUPABASE_V5.36_DELETE_ACCOUNT.sql no Supabase e tente de novo. Erro original: '+cloudErrorMessage(rpcError));
    }
