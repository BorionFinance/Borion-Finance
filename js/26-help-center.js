...
const HELP_ARTICLES=[
  ...
  article('senha-por-pares','inicio','Entrar com a senha por pares','O teclado seguro mostra dois algarismos por botão e reorganiza os pares sempre que a tela de senha é aberta.',[
    'Abra um perfil protegido por senha.',
    'Toque, na ordem correta, no par que contém cada algarismo da sua senha.',
    'As bolinhas indicam quantas posições já foram informadas, sem revelar os números.',
    'Use ⌫ para apagar a última posição ou ↻ para gerar novos pares.',
    'Toque em Entrar. O Borion compara somente as combinações possíveis com o hash protegido do perfil.',
    'Para senhas com letras ou símbolos, toque em Usar teclado comum.'
  ],['Os pares aleatórios aumentam a privacidade contra observação da tela. A proteção principal continua sendo o hash da senha e o isolamento do perfil.'],['senha itau','senha por pares','teclado seguro','pares aleatórios','números mudando','entrar no perfil']),
  ...
  article('estrutura-dados','inicio','Como o Borion organiza o dinheiro','O sistema trabalha com origem, destino, forma de pagamento, status e vínculo financeiro para manter saldos coerentes.',[
    ...
    'Compra no crédito não reduz a conta no momento da compra; ela cria parcela na fatura. Marcar a fatura como paga é apenas informativo e não altera o saldo da conta.',
  ...
  article('pesquisa-global','navegacao','Pesquisar compras, contas e categorias','A pesquisa do topo localiza registros do perfil sem exigir que você saiba em qual tela eles estão.',[
    ...
    'Para buscas financeiras mais detalhadas, abra a aba correspondente em Lançamentos e combine busca, categoria, origem e período.'
  ],[],['pesquisar','busca global','encontrar compra','filtros']),
  ...
  article('nova-receita','lancamentos','Adicionar uma receita','Receitas podem entrar em Carteira, Conta, Reserva ou ser divididas entre Conta e Reserva.',[
    ...
    'Salve e confira o lançamento na lista da aba e no saldo do destino.'
  ...
  article('despesa-variavel','lancamentos','Adicionar despesa variável','Despesa variável registra gastos pontuais e permite controlar pagamento, origem, cartão, parcela, loja e observações.',[
    ...
    'Salve e valide o registro na aba e no módulo financeiro relacionado.'
  ...
  article('reembolso-estorno-cartao','lancamentos','Reembolso e estorno de cartão','Registre devoluções sem transformar o valor em renda. O Borion preserva a compra original e recalcula o destino escolhido.',[
    'Abra Lançamentos, entre na aba Receita e clique em Adicionar.',
    'Em Origem da receita, escolha Reembolso recebido.',
    'Escolha Conta / Pix para dinheiro devolvido, Crédito na fatura para reduzir uma fatura, Abater compra para reduzir parcelas ou Vale da loja para saldo interno.',
    'No abatimento de compra, escolha distribuição proporcional, próximas parcelas ou manual.',
    'Faturas já pagas nunca são reescritas. Para alterar um estorno vinculado a elas, reabra primeiro a fatura.',
    'O valor aparece no histórico, reduz despesas e não aumenta a Receita do mês.'
  ],['Use Crédito na fatura quando a operadora apenas diminuiu o total da fatura; use Abater compra quando a própria compra ou as parcelas foram reduzidas.'],['reembolso','estorno','credito na fatura','abater compra','vale da loja','shein','devolucao']),
  ...
  article('editar-excluir','lancamentos','Editar, excluir e desfazer','As ações usam o registro original e protegem os efeitos financeiros vinculados.',[
    ...
    'Depois de alterações críticas, confira a lista da aba, a conta, a reserva e a fatura relacionada.'
  ...
  article('contas-carteira','cartoes','Cadastrar conta e entender a Carteira','Contas representam onde existe saldo disponível; Carteira é a conta especial de dinheiro físico.',[
    ...
    'Use uma conta para Pix, débito, transferências e como referência informativa da fatura.',
  ...
  article('cartao-cadastro','cartoes','Cadastrar cartão de crédito','Fechamento, vencimento e conta de pagamento determinam a competência das compras e a baixa da fatura.',[
    ...
    'Vincule a conta que será usada como referência informativa da fatura.',
  ...
  article('faturas','cartoes','Ler e pagar uma fatura','A fatura consolida compras e parcelas da competência. A marcação de pagamento serve para controle visual e para registrar uma conta de referência, sem reduzir o saldo bancário.',[
    ...
    'Ao marcar como paga, escolha a conta de referência e informe o valor efetivamente quitado.',
  ...
  ],['A despesa econômica ocorre nas compras. A marcação da fatura como paga apenas quita a dívida exibida e registra uma referência, sem movimentar a conta.'],['fatura','pagar cartão','dívida','pagamento parcial','duplicidade']),
  ...
  article('modulos-dashboard','personalizacao','Ativar módulos e organizar a Visão Geral','Módulos controlam o menu; os 18 widgets são organizados diretamente na Visão Geral.',[
    ...
    'Abra a Visão Geral e toque no lápis para exibir a grade, mover, redimensionar, ocultar ou reativar widgets.',
  ...
  article('ajuda-contextual-configuracoes','personalizacao','Usar os botões de ajuda nas Configurações','As Configurações foram simplificadas para mostrar somente controles essenciais. As explicações ficam nos pequenos botões de interrogação e na Central do Borion.',[
    ...
    'Em Organização e Visão Geral, ocultar uma área apenas esconde a interface; os dados continuam salvos.',
