...
assert(index.includes('rel="preload" href="css/styles.css?v=6.44.2"')&&index.includes('rel="preload" href="borion-emblem.png"'),'somente CSS/logo críticos devem ser preload');
