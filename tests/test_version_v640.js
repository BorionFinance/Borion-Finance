...
const NEW_VERSION='6.45.1';
const OLD_VERSION='6.44.6';
...
(function versionAppearsEverywhereExpected(){
  ...
  assert(swJs.includes('6-45-1'), 'sw.js deve ter um CACHE_NAME novo (nome de cache muda a cada versão — item 26)');
  ...
  assert(settings.includes('6.45'), 'tela de Configurações deve exibir a versão 6.45 visível ao usuário');
  console.log('OK: versão '+NEW_VERSION+' ("6.45.1 — Persistência Segura MIT") está presente em todos os locais esperados.');
})();
