...
(function versionAppearsEverywhereExpected(){
  ...
  assert(swJs.includes('6-42-0'), 'sw.js deve ter um CACHE_NAME novo (nome de cache muda a cada versão — item 26)');
  ...
  assert(settings.includes('6.42'), 'tela de Configurações deve exibir a versão 6.42 visível ao usuário');
  console.log('OK: versão '+NEW_VERSION+' ("6.42 — Boot e Sync Otimizados") está presente em todos os locais esperados.');
})();
