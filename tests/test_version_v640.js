...
(function versionAppearsEverywhereExpected(){
  ...
  assert(swJs.includes('6-45-0'), 'sw.js deve ter um CACHE_NAME novo (nome de cache muda a cada versão — item 26)');
  ...
  console.log('OK: versão '+NEW_VERSION+' ("6.45.0 — Integração Segura MIT") está presente em todos os locais esperados.');
})();
