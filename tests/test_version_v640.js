...
(function versionAppearsEverywhereExpected(){
  ...
  assert(swJs.includes('6-40-2'), 'sw.js deve ter um CACHE_NAME novo (nome de cache muda a cada versão — item 26)');
  ...
  assert(settings.includes('6.40'), 'tela de Configurações deve exibir a versão 6.40 visível ao usuário');
  console.log('OK: versão '+NEW_VERSION+' ("6.40 — Dados e Segurança") está presente em todos os locais esperados.');
})();
