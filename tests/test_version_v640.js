...
(function versionAppearsEverywhereExpected(){
  ...
  assert(swJs.includes('6-44-0'), 'sw.js deve ter um CACHE_NAME novo (nome de cache muda a cada versão — item 26)');
  ...
  console.log('OK: versão '+NEW_VERSION+' ("6.44 — Formas e Destinos das Receitas Integradas") está presente em todos os locais esperados.');
})();
